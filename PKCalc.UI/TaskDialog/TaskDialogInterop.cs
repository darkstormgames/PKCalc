...
namespace TaskDialogInterop
{
 ...
 // }
	...
	//				return false;
	//			if (os.Version.CompareTo(VistaTaskDialog.ModernOSVersion) >= 0)
	//				return false;
	...
	//	/// The minimum Windows version needed to support TaskDialog.
	//	/// </summary>
	//	public static Version ModernOSVersion
	//	{
	//		get { return new Version(10, 0, 0); }
	//	}
 ...
 //               this.radioButtons = value ?? throw new ArgumentNullException(nameof(value));
	...
	//		this.buttons = Array.Empty<VistaTaskDialogButton>();
	//		this.radioButtons = Array.Empty<VistaTaskDialogButton>();
	//		this.flags = 0;
 ...
 //       }
	...
	//	{
 //           return this.Show((owner == null ? IntPtr.Zero : new System.Windows.Interop.WindowInteropHelper(owner).Handle), out _, out _);
 //       }
	//	/// <summary>
	//	/// Creates, displays, and operates a task dialog. The task dialog contains application-defined messages, title,
	//	/// verification check box, command links and push buttons, plus any combination of predefined icons and push buttons
 ...
 //       }
	...
	//	{
 //           return this.Show((owner == null ? IntPtr.Zero : new System.Windows.Interop.WindowInteropHelper(owner).Handle), out verificationFlagChecked, out _);
 //       }
	//	/// <summary>
	//	/// Creates, displays, and operates a task dialog. The task dialog contains application-defined messages, title,
	//	/// verification check box, command links and push buttons, plus any combination of predefined icons and push buttons
