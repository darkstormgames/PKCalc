...
namespace TaskDialogInterop
{
	...
	/// </summary>
	public partial struct TaskDialogOptions
	{
		/// <summary>
		...
		/// <summary>
		/// Indicates the theme to be set as the dialogues.
		/// </summary>
		/// <remarks>
		/// Possible themes can be found at: https://mahapps.com/docs/themes/usage
		/// </remarks>
		public string Theme;
	}
	/// <summary>
	...
	public class TaskDialogButtonData
	{
		...
		/// </summary>
		public System.Windows.Input.ICommand Command { get; internal set; }
	...
	public interface IActiveTaskDialog
	{
		...
		/// <returns>If the function succeeds the return value is true.</returns>
		bool SetProgressBarState(ProgressBarState newState);
		/// <summary>
