	...
	public class TaskDialogViewModel : IActiveTaskDialog, INotifyPropertyChanged
	{
			...
			: this()
		{
			...
			if (options.EnableCallbackTimer)
			{
                ...
                _callbackTimer = new()
                {
                    Interval = CallbackTimerInterval
                };
		...
		public System.Windows.Media.ImageSource MainIcon
		{
            ...
            set
            {
                options.CustomMainIcon = new ImageConverter().ConvertTo(value, typeof(Icon)) as Icon;
		...
		public System.Windows.Media.ImageSource FooterIcon
		{
			...
			set
			{
				options.CustomFooterIcon = new ImageConverter().ConvertTo(value, typeof(Icon)) as Icon;
				RaisePropertyChangedEvent(nameof(MainIcon));
			}
		}
		/// <summary>
        ...
        public string Theme
        {
            ...
            {
                options.Theme = value;
                RaisePropertyChangedEvent(nameof(Theme));
            }
        }
		...
		public void NotifyConstructed()
		{
            ...
            {
                Config = this.options,
                Notification = TaskDialogNotification.DialogConstructed
            };
		...
		public void NotifyCreated()
		{
            ...
            {
                Config = this.options,
                Notification = TaskDialogNotification.Created
            };
		...
		public void NotifyClosed()
		{
            ...
            {
                Config = this.options,
                Notification = TaskDialogNotification.Destroyed
            };
		...
		private void CallbackTimer_Tick(object sender, EventArgs e)
		{
            ...
            {
                Config = this.options,
                Notification = TaskDialogNotification.Timer,
                TimerTickCount = Convert.ToUInt32(Math.Round(DateTime.Now.Subtract(_callbackTimerStart).TotalMilliseconds, 0))
            };

            OnCallback(args);
		}
		[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Security", "CA2122:DoNotIndirectlyExposeMethodsWithLinkDemands")]
		private static System.Windows.Media.ImageSource ConvertIconToImageSource(TaskDialogIcon icon, Icon customIcon, bool isLarge)
		{
			...
			try
			{
				switch (icon)
				{
					...
					case TaskDialogIcon.Shield:
						if (isLarge)
						{
							altBmp = PKCalc.UI.Properties.Resources.shield_32;
						}
						else
						{
							altBmp = PKCalc.UI.Properties.Resources.shield_16;
						}
						break;
				}
		...
		private static string[] FixLabelAccessKeys(string[] labels)
		{
		...
		bool IActiveTaskDialog.SetProgressBarState(ProgressBarState newState)
		{
